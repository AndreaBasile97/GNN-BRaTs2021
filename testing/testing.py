...
import pandas as pd
import argparse
from training.utilities import predict, save_settings
...
if args.model == 'GraphSage':
    ...
    test_model = GAT(in_feats, layer_sizes, n_classes, heads, residuals, feat_drop = val_feat_drop, attn_drop = val_attn_drop)


save_settings(timestamp, test_model, patience, lr, weight_decay, gamma, args.model, heads, residuals, \
              val_dropout, layer_sizes, in_feats, n_classes, val_feat_drop, val_attn_drop, dataset_pickle_path, model_path = val_model_path)
